<template>
  <div class="container mt-4">
    <TableauComp :rafraîchir="ensembleRole" modifierURL="/role" :donnés="role" />

    <div class="d-flex justify-content-end"><button data-bs-toggle="modal"
            data-bs-target="#create-role" class="btn btn-outline-success"><i class="bi bi-plus"></i></button></div></div>
      <!-- Modal -->
      <div class="modal fade" id="create-role" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label class="text-capitalize" for="taper">Taper</label>
            <input type="text" id="taper" class="form-control mb-2" v-model="name">
          </div>
...
const { ensembleRole } = store
const { role, jetonDaccès } = storeToRefs(store)
