<template>
  <div class="container mt-4">
    <TableauComp :rafraîchir="ensembleFacture" modifierURL="/invoice" :donnés="facture" />

    <div class="d-flex justify-content-end"><button data-bs-toggle="modal" data-bs-target="#create-facture"
        class="btn btn-outline-success"><i class="bi bi-plus"></i></button></div>
  </div>
  <!-- Modal -->
  <div class="modal fade" id="create-facture" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="text-capitalize" for="totale">Prix</label>
            <input type="text" id="totale" class="form-control mb-2" v-model="total">
          </div>
          <div class="form-group">
            <label class="text-capitalize" for="article">Description</label>
            <input type="text" id="article" class="form-control mb-2" v-model="item">
          </div>
          <div class="form-group">
...
const { ensembleFacture } = store
const { facture, jetonDaccès } = storeToRefs(store)
